...
self.addEventListener('activate', event => {
  ...
  // 允许一个激活的service worker将其设置为其他同scope下的clients的controller。该方法会触发要被该service worker控制的其他任何clients的navigator.serviceWorker上的"controllerchange"事件。
  self.clients.claim();
